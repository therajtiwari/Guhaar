...
export default async (
  ...
  var canapprove = await Moralis.Web3API.native.runContractFunction(readOptions2);
  const readOptions3 = {
    chain: "rinkeby",
    address: id,
  ...
  canapprove = canapprove && !(await Moralis.Web3API.native.runContractFunction(readOptions3));
