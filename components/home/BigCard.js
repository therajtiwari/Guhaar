    ...
    <div style={{ margin: "0px 2rem " }}>
      <Grid container className={styles.BigCardWrapper}>
        ...
        <Grid item md={6} sm={10} className={styles.infoWrapper}>
          <h3 style={{ color: "#606060", marginBottom: "10px" }}>
            {campaign[6]}
          </h3>
          <h2 style={{ padding: "13px auto", fontSize: "1.5rem" }}>
            {campaign[2]}
          </h2>
          <p
            style={{
          ...
          >
            ...
            {campaign[3].length < 300
              ? campaign[3]
              : campaign[3].slice(0, 300) + "..."}
          </p>

          <div className={styles.addInfo}>
            <div className="raised" style={{ marginRight: "auto" }}>
              <h2 style={{ padding: "12px auto" }}>
                ₹{" "}
                {parseFloat(
                  campaign["price"] * ethers.utils.formatEther(campaign[5])
                ).toFixed(2)}
              </h2>
              <p
                style={{
              ...
              >
                To be Raised ⧫{ethers.utils.formatEther(campaign[5])}
              </p>
            </div>
